state("WaveLand")
{
	byte level : 0x048D47D8;
	double bossHp : 0x048CDE18, 0x0, 0x6A0, 0xC, 0xC8, 0x8, 0x58, 0x10, 0x7C, 0x0;
	double sword : 0x048CDE18, 0x0, 0x0, 0xC, 0xC8, 0x8, 0x58, 0x10, 0xB8C, 0x0;
	long nanosecondCounter : 0x0482D3B0;
	double wraithDead : 0x048CDE18, 0x0, 0x358, 0xC, 0xC8, 0x8, 0x58, 0x10, 0x1C, 0x0;
}
